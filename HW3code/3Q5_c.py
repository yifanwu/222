...
def forward_n():
  ...
  for i in xrange(1,10):
    for j in xrange(1,1001):
      ...
      #However, the other counters are set to the maximum of their old value and the new value of the smallest counter
      for h in xrange(0,4):
